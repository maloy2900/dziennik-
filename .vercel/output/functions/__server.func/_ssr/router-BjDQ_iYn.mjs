...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BjDQ_iYn.js
...
var TooltipContent = import_react.forwardRef(({ className, sideOffset = 6, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2, {
	ref,
	sideOffset,
	className: cn("z-50 overflow-hidden rounded-md border border-border bg-elevated px-2.5 py-1.5 text-xs text-fg shadow-panel", className),
	...props
}) }));
TooltipContent.displayName = Content2.displayName;
var styles_default = "/assets/styles-Dln57YD9.css";
var APP_NAME = "Dziennik Tradera";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Dziennik transakcji z automatycznym winrate, średnim RR, saldem i wykresem equity. Dane zapisują się lokalnie."
			},
			{
				name: "theme-color",
				content: "#0c0d0f"
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
					...
					toastOptions: { className: "bg-elevated text-fg border border-border shadow-panel font-sans" }
				}),
...
var $$splitComponentImporter = () => import("./routes-BxnwPTJw.mjs");
...
//#endregion
export { cn as n, uid as r, router_exports as t };
